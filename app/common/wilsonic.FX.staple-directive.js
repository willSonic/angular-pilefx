...
;( function( $, window, undefined ) {
    ...
    $special = $event.special.debouncedresize = {
        setup: function() {
            console.log("$event.special.debouncedresize setup line 30");
            $( this ).on( "resize", $special.handler );
        },
        teardown: function() {
            console.log("$event.special.debouncedresize teardown line 33");
            $( this ).off( "resize", $special.handler );
        },
        handler: function( event, execAsap ) {
            console.log("$event.special.debouncedresize handler line 38");
            // Save the context
            var context = this,
                args = arguments,
                dispatch = function() {
    ...
    var BLANK = 'data:styles/image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==';
    ...
    $.Stapel = function( options, element ) {
        ...
        console.log("    $.Stapel = function   line 187");
        this.el = $( element );
        this._init( options );
    ...
    $.Stapel.prototype = {
        ...
        _init : function( options ) {
            ...
            console.log("    $.Stapel.prototype init   line 229");
            // options
        ...
        _config : function() {
            ...
            console.log("    $.Stapel.prototype config   line 247");
        ...
        _getSize : function() {
            ...
            console.log("    $.Stapel.prototype getSize   line 286");
            this.elWidth = this.el.outerWidth( true );

        },
        _initEvents : function() {

            console.log("    $.Stapel.prototype _initEvents   line 290");
            var self = this;
        ...
        _layout : function() {
            ...
            console.log("    $.Stapel.prototype _layout   line 341");
            this._piles();
        ...
        _piles : function() {
            ...
            console.log("    $.Stapel.prototype _piles   line 371");
            this.piles = {};
        ...
        _setInitialStyle : function() {
            console.log("    $.Stapel.prototype _setInitialStyle   line 407");
        ...
        _applyInitialTransition : function( $el ) {
            console.log("    $.Stapel.prototype _applyInitialTransition   line 447");
            if( this.support ) {
        ...
        _setItemsPosition : function() {
            ...
            console.log("    $.Stapel.prototype _setItemsPosition   line 455");
        ...
        _openPile : function() {
            ...
            console.log("    $.Stapel.prototype _openPile   line 543");
            if( !this.spread ) {
                return false;
            }
        ...
        _closePile : function() {
            ...
            console.log("    $.Stapel.prototype _closePile   line 639");
            var self = this;
        ...
        _resize : function() {
            ...
            console.log("    $.Stapel.prototype _resize   line 751");
            // get ul size again
            this._getSize();
        ...
        _applyTransition : function( el, styleCSS, speed, fncomplete ) {
            ...
            console.log("    $.Stapel.prototype _applyTransition   line 761");
        ...
        closePile : function() {
            ...
            console.log("    $.Stapel.prototype  closePile   line 777");
            this._closePile();
    ...
    $.fn.stapel = function( options ) {
        ...
        if ( typeof options === 'string' ) {
            ...
            console.log("Staple BEFORE EACH IN  APPLY");
            ...
            this.each(function() {
                ...
                console.log("Staple CALLING APPLY");
            ...
            this.each(function() {
                ...
                if ( instance ) {
                     console.log("Staple instance NOT NULL calling init()");
                    instance._init();

                }
                else {
                    console.log("Staple instance NULL CREATING INSTANCE");
